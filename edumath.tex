...
Serifenlose Schrift wird durch \opt{sfmath} entweder durch das Package \pkg{noto} eingebunden (sofern Noto durch \opt{rmmathfont} gewählt wurde) oder mithilfe des Packages \pkg{sansmath} die aktuelle serifenlose Schrift als Schrift für den Formelsatz gewählt. Im zweiten Fall werden außerdem griechische serifenlose Buchstaben der Schrift \emph{Iwona} verwendet.
Als Blackboard-Schrift wird durch das Package \pkg{mathalpha} die serifenlose Variante von \emph{Doublestroke} des Packages \pkg{dsfont} gewählt. 
