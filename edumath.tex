...
\DescribeMacro\absvect*{<Spalte>}
%
Durch \Macro\absvect kann auf einfache Weise der Betrag eines Vektors angegeben werden. Hierbei müssen die Einträge des Vektors durch \texttt{\textbackslash\textbackslash}\ getrennt werden. In der Sternvariante skalieren die Betragsstriche im Vergleich zur normalen Variante nicht.
}
